...
function booksByAuthor(dictionary) {
  ...
  /*Object.keys(dictionary).forEach(function (element) {
    books.push({ author: element });
  });*/
  /*for (const author of Object.values(dictionary)) {
    books.push(author);
  }*/
  for (const author in dictionary) {
    ...
    /*books.push({
      title: dictionary[author][0],
      pages: dictionary[author][1],
      author: author,
    });*/
  }
...
function averagePageCount(books) {
  ...
  pageCount = pagesSum / books.length;
